...
public class areaAcesso extends JFrame {
	...
	public areaAcesso() {
		...
		JLabel lbldesen = new JLabel("Desenvolvido por Daniel Limas Alexandre \r");
		...
		JLabel lbl2 = new JLabel("Para a disciplica de");
			...
			gl_panelLogin.createParallelGroup(Alignment.TRAILING)
				...
				.addGroup(gl_panelLogin.createSequentialGroup()
					...
					.addGroup(gl_panelLogin.createParallelGroup(Alignment.TRAILING)
						...
						.addComponent(passwordField, GroupLayout.DEFAULT_SIZE, 238, Short.MAX_VALUE))
					.addGap(30))
				.addGroup(gl_panelLogin.createSequentialGroup()
		...
		gl_panelLogin.setVerticalGroup(
			gl_panelLogin.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelLogin.createSequentialGroup()
					...
					.addComponent(lblLogin)
					.addGap(36)
					.addComponent(txtUsuarioemail, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
					...
					.addGap(28)
					.addComponent(btnAcessar, GroupLayout.PREFERRED_SIZE, 28, GroupLayout.PREFERRED_SIZE)
					.addGap(18)
					.addComponent(lblEsqueceuSuaSenha)
