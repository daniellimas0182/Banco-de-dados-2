...
public class telaPrincipal extends JFrame {
	...
	private opcao05 op05 = new opcao05();
	private JButton btn01, btn02, btn03, btn04, btn05;
	private JDesktopPane desktopPane;

	public telaPrincipal(String user) {
		opcao01 op01 = new opcao01(user);
		opcao02 op02 = new opcao02(user);
		...
		gl_desktopPane.setHorizontalGroup(
				gl_desktopPane.createParallelGroup(Alignment.LEADING).addGap(0, 453, Short.MAX_VALUE));
		gl_desktopPane.setVerticalGroup(
				gl_desktopPane.createParallelGroup(Alignment.LEADING).addGap(0, 462, Short.MAX_VALUE));
		...
		btn01.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				desktopPane.add(op01);
				op01.setVisible(true);
				setPosicaoOp01();
			...
			private void setPosicaoOp01() {
				op01.setLocation(desktopPane.getWidth() / 2 - op01.getWidth() / 2,
						desktopPane.getHeight() / 2 - op01.getHeight() / 2);
			}
		});
		...
		btn02.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				desktopPane.add(op02);
				op02.setVisible(true);
				setPosicaoOp02();
			...
			private void setPosicaoOp02() {
				op02.setLocation(desktopPane.getWidth() / 2 - op02.getWidth() / 2,
						desktopPane.getHeight() / 2 - op02.getHeight() / 2);
			}
		});
		...
		btn03.addActionListener(new ActionListener() {
			...
			private void setPosicaoOp03() {
				op03.setLocation(desktopPane.getWidth() / 2 - op03.getWidth() / 2,
						desktopPane.getHeight() / 2 - op03.getHeight() / 2);
			}
		});
		...
		btn04.addActionListener(new ActionListener() {
			...
			private void setPosicaoOp04() {
				op04.setLocation(desktopPane.getWidth() / 2 - op04.getWidth() / 2,
						desktopPane.getHeight() / 2 - op04.getHeight() / 2);
			}
		});
		btn04.setBackground(new Color(72, 61, 139));
		...
		btn05 = new JButton("Agenda");
		btn05.setIcon(new ImageIcon("img\\agenda.png"));
		btn05.setBounds(0, 292, 258, 45);
		btn05.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				desktopPane.setBackground(new Color(102, 102, 51));
				desktopPane.add(op05);
				op05.setVisible(true);
				setPosicaoOp05();
				op05.modelo.setNumRows(0);
				op05.carregarTabela();
			...
			private void setPosicaoOp05() {
				op05.setLocation(desktopPane.getWidth() / 2 - op05.getWidth() / 2,
						desktopPane.getHeight() / 2 - op05.getHeight() / 2);
			}
		});
		btn05.setBackground(new Color(72, 61, 139));
